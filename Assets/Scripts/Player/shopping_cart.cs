...
public class shopping_cart : MonoBehaviour
{
	...
	public void playBoostSound(){
		scoreScript.playSpeedboostClip();
	}
    ...
    void OnGUI(){
		...
		if(isDisplayed && closestObject != null){
			...
			GUI.Label(new Rect(objectScreenPosition.x, Screen.height - objectScreenPosition.y, 400, 100), interactObject.interactMessage + " " + interactObject.objectName + "\r\n<i>" + interactObject.objectDescription + "</i>");
		}
	}
}